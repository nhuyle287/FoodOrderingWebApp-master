...
namespace FoodOrderingWebApp.Controllers
{
    ...
    {
        private readonly FoodOrderingWebAppDbContext _context;

        public HoaDonController(FoodOrderingWebAppDbContext context)
        {
            _context = context;
        }
        ...
        {
            var foodOrderingWebAppDbContext = _context.HoaDon.Include(h => h.KhachHang).Include(h => h.NhanVien).Include(h => h.PhiShip);
            return View(await foodOrderingWebAppDbContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("HoaDonId,NgayTao,PhuongThucThanhToan,NgayGiao,SoNha,Quan,PhiShipId,TongTienThanhToan,TinNhan,TrangThai,NhanVienId,KhachHangId")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HoaDonId,NgayTao,PhuongThucThanhToan,NgayGiao,SoNha,Quan,PhiShipId,TongTienThanhToan,TinNhan,TrangThai,NhanVienId,KhachHangId")] HoaDon hoaDon)
        {
